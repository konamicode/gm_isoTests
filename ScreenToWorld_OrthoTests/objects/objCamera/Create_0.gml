...
function UpdateCameraPos() {
	...
	projmat = matrix_build_projection_ortho(screenWidth * 0.75, screenHeight * 0.75, -16000, 16000);
...
function ResetCamera() {
	...
	viewmat = matrix_build_lookat(screenWidth/2 + 2.5, screenHeight/2 + (window_scale div 2), -16000, screenWidth/2 + 2.5, screenHeight/2 + (window_scale div 2), 16000, 0, 1, 0);
